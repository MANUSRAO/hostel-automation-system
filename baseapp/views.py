...
def addStudent(request):
    if request.method=='POST':
        ...
        if User.objects.filter(username=username).exists():
            ...
            message = "Your Account has been created successfully, your username is "+username+", password is '"+password+"' . We request you to change your password by the earliest."
